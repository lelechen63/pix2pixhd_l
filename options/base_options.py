...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='deepfashion_man', help='name of the experiment. It decides where to store samples and models')        
        ...
        # for setting inputs
        self.parser.add_argument('--dataset', type=str, default='densepose') 
        self.parser.add_argument('--dataroot', type=str, default='/data/lchen63/high_deepfashion') 
